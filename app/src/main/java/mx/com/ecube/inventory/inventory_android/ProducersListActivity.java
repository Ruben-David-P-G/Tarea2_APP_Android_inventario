...
public class ProducersListActivity extends AppCompatActivity  implements  Response.Listener,Response.ErrorListener{
    ...
    public void onResponse(Object response) {
        ...
        try {
            ...
            final ListView list=findViewById(R.id.ProducersList);
            ...
            public void onItemClick (AdapterView < ? > adapter, View view,int position, long arg){
                ...
                Intent b =new Intent(view.getContext(),ProducersEditActivity.class);
